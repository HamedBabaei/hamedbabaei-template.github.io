...
const cartItem = document.querySelector(".cart-items"); //in carts in the bag
//cart
let cart = [];
//buttons
let buttonsDOM = []
        ...
        <div class="col-md-3 product">
          <div class="card text-center">
            <div class="img-container">
              <img class="card-imd-top card-img product-img" 
              src=${product.image} />
        ...
        buttons.forEach(button => {
            ...
            if (inCart) {
                ...
                button.addEventListener('click', (event) => {
                    ...
                    // set the cart values, cart totals and ... 
    ...
    cartLogic() {
        ...
        cartContent.addEventListener('click', event => {
            if (event.target.classList.contains('remove-item')) {
                ...
                //console.log(removeItem.parentElement.parentElement.parentElement.parentElement);
